...
declare const CodeEditor: (props: Props$3) => react_jsx_runtime.JSX.Element;
...
declare function LiveProvider({ children, code, language, theme, enableTypeScript, disabled, scope, transformCode, noInline, }: PropsWithChildren<Props$2>): react_jsx_runtime.JSX.Element;

declare function LiveEditor(props: Partial<Props$3>): react_jsx_runtime.JSX.Element;

declare function LiveError<T extends Record<string, unknown>>(props: T): react_jsx_runtime.JSX.Element | null;
...
declare function withLive<T>(WrappedComponent: ComponentType<T & Props>): {
    (props: T): react_jsx_runtime.JSX.Element;
    displayName: string;
};
